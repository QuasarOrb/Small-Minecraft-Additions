	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armright = partdefinition.addOrReplaceChild("armright",
				CubeListBuilder.create().texOffs(24, 33)
						.addBox(-15.0F, -30.0F, -14.0F, 1.0F, 29.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 44)
		...
		PartDefinition arm1_r1 = armright.addOrReplaceChild("arm1_r1",
				CubeListBuilder.create().texOffs(29, 0).addBox(-15.0F, -3.0F, -3.0F, 19.0F, 3.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -24.0F, 0.0F, 0.0F, -0.8727F, -0.3491F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 33)
						.addBox(-3.0F, -35.0F, -3.0F, 7.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(36, 7)
		...
		PartDefinition armleft = partdefinition.addOrReplaceChild("armleft", CubeListBuilder.create().texOffs(0, 45)
				.addBox(10.0F, -10.0F, -4.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition arm2_r1 = armleft.addOrReplaceChild("arm2_r1",
				CubeListBuilder.create().texOffs(32, 29).addBox(-16.1763F, -3.7622F, -2.3673F, 18.0F, 3.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition other = partdefinition.addOrReplaceChild("other",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(2.0F, -1.0F, -4.0F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
